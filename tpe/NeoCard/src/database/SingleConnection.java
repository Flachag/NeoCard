...
/**
 * Permet une connexion unique avec la base de donnée. L'énumération permet
 * d'assurer un singleton malgré le multithread. Accessible uniquement dans le
 * package database.
 */
enum SingleConnection {
	...
	/**
	 * Constructeur PRIVE initialisant la connexion avec la base de donnée. (car
	 * enum) Java l'appelle automatiquement la PREMIERE FOIS que l'on tente
	...
	/**
	 * Retourne une connexion avec la base de donnée. Utilise le fichier
	 * /conf/database.conf pour les paramètres de connexion. (user etc)
	 * 
