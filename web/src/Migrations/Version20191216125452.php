...
final class Version20191216125452 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE carte ADD CONSTRAINT FK_BAD4FFFDACE7FAFA FOREIGN KEY (idCompte) REFERENCES account (idAccount)');
        $this->addSql('ALTER TABLE account ADD CONSTRAINT FK_CFF65260AD9BEC3D FOREIGN KEY (idUser) REFERENCES user (idUtil)');
        $this->addSql('ALTER TABLE tpe ADD CONSTRAINT FK_BE5EF5BFACE7FAFA FOREIGN KEY (idCompte) REFERENCES account (idAccount)');
        $this->addSql('ALTER TABLE transaction ADD CONSTRAINT FK_723705D152127D6 FOREIGN KEY (issuer) REFERENCES account (idAccount)');
        $this->addSql('ALTER TABLE transaction ADD CONSTRAINT FK_723705D1FDE0DADF FOREIGN KEY (receiver) REFERENCES account (idAccount)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE account DROP FOREIGN KEY FK_CFF65260AD9BEC3D');
